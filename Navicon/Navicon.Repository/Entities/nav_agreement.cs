...
namespace Navicon.Repository.Entities
{
	...
	public partial class nav_agreement : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Navicon.Repository.Entities.nav_agreementState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Navicon.Repository.Entities.nav_agreementState)(System.Enum.ToObject(typeof(Navicon.Repository.Entities.nav_agreementState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Navicon.Repository.Entities.nav_invoice> nav_nav_agreement_nav_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Navicon.Repository.Entities.nav_invoice>("nav_nav_agreement_nav_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_nav_agreement_nav_invoice_dogovorid");
				this.SetRelatedEntities<Navicon.Repository.Entities.nav_invoice>("nav_nav_agreement_nav_invoice_dogovorid", null, value);
		...
		public Navicon.Repository.Entities.Contact nav_contact_nav_agreement_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Navicon.Repository.Entities.Contact>("nav_contact_nav_agreement_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_agreement_contact");
				this.SetRelatedEntity<Navicon.Repository.Entities.Contact>("nav_contact_nav_agreement_contact", null, value);
