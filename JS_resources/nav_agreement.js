...
Navicon.nav_agreement  = (function()
{
                ...
                function(creditDate){
                    ...
                    { 
                        dateControl.addNotification({
                            messages: [`РґРѕР»Р¶РЅР° Р±С‹С‚СЊ РјРµРЅСЊС€Рµ РґР°С‚С‹ РѕРєРѕРЅС‡Р°РЅРёСЏ РєСЂРµРґРёС‚РЅРѕР№ РїСЂРѕРіСЂР°РјРјС‹.`],
    ...
    var checkUserRoles = function () {
        ...
        roles.forEach(function (item) {
            if (item.name.toLowerCase() === "РЎРёСЃС‚РµРјРЅС‹Р№ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ" || item.id === "e93e2711-f165-ee11-9ae7-00224882b270") {
                hasRole = true;
            }
        });
